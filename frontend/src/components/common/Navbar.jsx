    ...
    <nav className="sticky top-0 z-50 bg-gray-900/90 backdrop-blur shadow-lg shadow-gray-900/20">
      <div className="container mx-auto px-4">
        <div className="flex h-20 items-center justify-between">
          ...
          {/* DESKTOP SEARCH BAR */}
          <form onSubmit={handleNavbarSearch} className="flex-grow max-w-xl mx-8 hidden lg:block">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 border border-gray-300 bg-white text-gray-800 placeholder-gray-500 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500"
              />
            </div>
          </form>
